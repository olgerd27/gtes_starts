...
-- Trying to concatenate file path with name -> don't successful. Maybe there are need to create
-- the stored procedure, that returns concatenated string to the "LOAD DATA LOCAL INFILE" method.
-- SET @DATA_PATH = '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/names_engines.dat';
-- SET @FILE_NAME = CONCAT(@DATA_PATH, "'names_engines.dat'");
