...
LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/names_modifications_engines.dat'
REPLACE
INTO TABLE gtes_starts.names_modifications_engines
CHARACTER SET cp1251;

LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/identification_data_engines.dat'
REPLACE
...
LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/start_devices.dat'
REPLACE
...
LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/combustion_chambers.dat'
REPLACE
...
LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/graphs_parameters_values.dat'
REPLACE
INTO TABLE gtes_starts.graphs_parameters_values
CHARACTER SET cp1251;

LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/engines_graphs.dat'
REPLACE
...
LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/documents.dat'
REPLACE
INTO TABLE gtes_starts.documents
CHARACTER SET cp1251;

LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/engines_documents.dat'
REPLACE
INTO TABLE gtes_starts.engines_documents
CHARACTER SET cp1251;

LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/alg_par_types.dat'
REPLACE
INTO TABLE gtes_starts.alg_par_types
CHARACTER SET cp1251;

LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/alg_parameters_names.dat'
REPLACE
INTO TABLE gtes_starts.alg_parameters_names
CHARACTER SET cp1251;

LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/engines_algorithms.dat'
REPLACE
...
LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/bypasses.dat'
REPLACE
INTO TABLE gtes_starts.bypasses
CHARACTER SET cp1251;

LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/bypass_mount_places.dat'
REPLACE
INTO TABLE gtes_starts.bypass_mount_places
CHARACTER SET cp1251;

LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/engines_bypasses.dat'
REPLACE
...
LOAD DATA LOCAL INFILE '~/Programming/qt/projects/Starts_data_base/development/project/db/scripts/test_data/engines_settings.dat'
REPLACE
